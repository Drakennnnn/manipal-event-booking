...
import { Layout, Select, Typography, Card, Button, Row, Col, Divider } from 'antd';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography.Title level={5} style={{ color: '#fff', margin: '0 10px' }}>College Event Manager</Typography.Title>
          </div>
          <div>
            ...
            <Col key={index} xs={24} sm={12} md={8}>
              ...
              >
                ...
                <Button 
                  ...
                  onClick={() => router.push(`/register?event=${encodeURIComponent(event.title)}`)}
                >
                  Register Now
                </Button>
              </Card>
